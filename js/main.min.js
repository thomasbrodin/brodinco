...
}).delegate(".ui-tabs-anchor","focus"+this.eventNamespace,function(){t(this).closest("li").is(".ui-state-disabled")&&this.blur()}),this.tabs=this.tablist.find("> li:has(a[href])").addClass("ui-state-default ui-corner-top").attr({role:"tab",tabIndex:-1}),this.anchors=this.tabs.map(function(){return t("a",this)[0]}).addClass("ui-tabs-anchor").attr({role:"presentation",tabIndex:-1}),this.panels=t(),this.anchors.each(function(i,n){var s,o,a,r=t(n).uniqueId().attr("id"),l=t(n).closest("li"),h=l.attr("aria-controls");e._isLocal(n)?(s=n.hash,a=s.substring(1),o=e.element.find(e._sanitizeSelector(s))):(a=l.attr("aria-controls")||t({}).uniqueId()[0].id,s="#"+a,o=e.element.find(s),o.length||(o=e._createPanel(a),o.insertAfter(e.panels[i-1]||e.tablist)),o.attr("aria-live","polite")),o.length&&(e.panels=e.panels.add(o)),h&&l.data("ui-tabs-aria-controls",h),l.attr({"aria-controls":a,"aria-labelledby":r}),o.attr("aria-labelledby",r)}),this.panels.addClass("ui-tabs-panel ui-widget-content ui-corner-bottom").attr("role","tabpanel"),i&&(this._off(i.not(this.tabs)),this._off(n.not(this.anchors)),this._off(s.not(this.panels)))},_getList:function(){return this.tablist||this.element.find("ol,ul").eq(0)},_createPanel:function(e){return t("<div>").attr("id",e).addClass("ui-tabs-panel ui-widget-content ui-corner-bottom").data("ui-tabs-destroy",!0)},_setupDisabled:function(e){t.isArray(e)&&(e.length?e.length===this.anchors.length&&(e=!0):e=!1);for(var i,n=0;i=this.tabs[n];n++)e===!0||-1!==t.inArray(n,e)?t(i).addClass("ui-state-disabled").attr("aria-disabled","true"):t(i).removeClass("ui-state-disabled").removeAttr("aria-disabled");this.options.disabled=e},_setupEvents:function(e){var i={};e&&t.each(e.split(" "),function(t,e){i[e]="_eventHandler"}),this._off(this.anchors.add(this.tabs).add(this.panels)),this._on(!0,this.anchors,{click:function(t){t.preventDefault()}}),this._on(this.anchors,i),this._on(this.tabs,{keydown:"_tabKeydown"}),this._on(this.panels,{keydown:"_panelKeydown"}),this._focusable(this.tabs),this._hoverable(this.tabs)},_setupHeightStyle:function(e){var i,n=this.element.parent();"fill"===e?(i=n.height(),i-=this.element.outerHeight()-this.element.height(),this.element.siblings(":visible").each(function(){var e=t(this),n=e.css("position");"absolute"!==n&&"fixed"!==n&&(i-=e.outerHeight(!0))}),this.element.children().not(this.panels).each(function(){i-=t(this).outerHeight(!0)}),this.panels.each(function(){t(this).height(Math.max(0,i-t(this).innerHeight()+t(this).height()))}).css("overflow","auto")):"auto"===e&&(i=0,this.panels.each(function(){i=Math.max(i,t(this).height("").height())}).height(i))},_eventHandler:function(e){var i=this.options,n=this.active,s=t(e.currentTarget),o=s.closest("li"),a=o[0]===n[0],r=a&&i.collapsible,l=r?t():this._getPanelForTab(o),h=n.length?this._getPanelForTab(n):t(),c={oldTab:n,oldPanel:h,newTab:r?t():o,newPanel:l};e.preventDefault(),o.hasClass("ui-state-disabled")||o.hasClass("ui-tabs-loading")||this.running||a&&!i.collapsible||this._trigger("beforeActivate",e,c)===!1||(i.active=r?!1:this.tabs.index(o),this.active=a?t():o,this.xhr&&this.xhr.abort(),h.length||l.length||t.error("jQuery UI Tabs: Mismatching fragment identifier."),l.length&&this.load(this.tabs.index(o),e),this._toggle(e,c))},_toggle:function(e,i){function n(){o.running=!1,o._trigger("activate",e,i)}function s(){i.newTab.closest("li").addClass("ui-tabs-active ui-state-active"),a.length&&o.options.show?o._show(a,o.options.show,n):(a.show(),n())}var o=this,a=i.newPanel,r=i.oldPanel;this.running=!0,r.length&&this.options.hide?this._hide(r,this.options.hide,function(){i.oldTab.closest("li").removeClass("ui-tabs-active ui-state-active"),s()}):(i.oldTab.closest("li").removeClass("ui-tabs-active ui-state-active"),r.hide(),s()),r.attr("aria-hidden","true"),i.oldTab.attr({"aria-selected":"false","aria-expanded":"false"}),a.length&&r.length?i.oldTab.attr("tabIndex",-1):a.length&&this.tabs.filter(function(){return 0===t(this).attr("tabIndex")}).attr("tabIndex",-1),a.attr("aria-hidden","false"),i.newTab.attr({"aria-selected":"true","aria-expanded":"true",tabIndex:0})},_activate:function(e){var i,n=this._findActive(e);n[0]!==this.active[0]&&(n.length||(n=this.active),i=n.find(".ui-tabs-anchor")[0],this._eventHandler({target:i,currentTarget:i,preventDefault:t.noop}))},_findActive:function(e){return e===!1?t():this.tabs.eq(e)},_getIndex:function(t){return"string"==typeof t&&(t=this.anchors.index(this.anchors.filter("[href$='"+t+"']"))),t},_destroy:function(){this.xhr&&this.xhr.abort(),this.element.removeClass("ui-tabs ui-widget ui-widget-content ui-corner-all ui-tabs-collapsible"),this.tablist.removeClass("ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all").removeAttr("role"),this.anchors.removeClass("ui-tabs-anchor").removeAttr("role").removeAttr("tabIndex").removeUniqueId(),this.tablist.unbind(this.eventNamespace),this.tabs.add(this.panels).each(function(){t.data(this,"ui-tabs-destroy")?t(this).remove():t(this).removeClass("ui-state-default ui-state-active ui-state-disabled ui-corner-top ui-corner-bottom ui-widget-content ui-tabs-active ui-tabs-panel").removeAttr("tabIndex").removeAttr("aria-live").removeAttr("aria-busy").removeAttr("aria-selected").removeAttr("aria-labelledby").removeAttr("aria-hidden").removeAttr("aria-expanded").removeAttr("role")}),this.tabs.each(function(){var e=t(this),i=e.data("ui-tabs-aria-controls");i?e.attr("aria-controls",i).removeData("ui-tabs-aria-controls"):e.removeAttr("aria-controls")}),this.panels.show(),"content"!==this.options.heightStyle&&this.panels.css("height","")},enable:function(e){var i=this.options.disabled;i!==!1&&(void 0===e?i=!1:(e=this._getIndex(e),i=t.isArray(i)?t.map(i,function(t){return t!==e?t:null}):t.map(this.tabs,function(t,i){return i!==e?i:null})),this._setupDisabled(i))},disable:function(e){var i=this.options.disabled;if(i!==!0){if(void 0===e)i=!0;else{if(e=this._getIndex(e),-1!==t.inArray(e,i))return;i=t.isArray(i)?t.merge([e],i).sort():[e]}this._setupDisabled(i)}},load:function(e,i){e=this._getIndex(e);var n=this,s=this.tabs.eq(e),o=s.find(".ui-tabs-anchor"),a=this._getPanelForTab(s),r={tab:s,panel:a},l=function(t,e){"abort"===e&&n.panels.stop(!1,!0),s.removeClass("ui-tabs-loading"),a.removeAttr("aria-busy"),t===n.xhr&&delete n.xhr};this._isLocal(o[0])||(this.xhr=t.ajax(this._ajaxSettings(o,i,r)),this.xhr&&"canceled"!==this.xhr.statusText&&(s.addClass("ui-tabs-loading"),a.attr("aria-busy","true"),this.xhr.done(function(t,e,s){setTimeout(function(){a.html(t),n._trigger("load",i,r),l(s,e)},1)}).fail(function(t,e){setTimeout(function(){l(t,e)},1)})))},_ajaxSettings:function(e,i,n){var s=this;return{url:e.attr("href"),beforeSend:function(e,o){return s._trigger("beforeLoad",i,t.extend({jqXHR:e,ajaxSettings:o},n))}}},_getPanelForTab:function(e){var i=t(e).attr("aria-controls");return this.element.find(this._sanitizeSelector("#"+i))}}),t.widget("ui.tooltip",{version:"1.11.4",options:{content:function(){var e=t(this).attr("title")||"";return t("<a>").text(e).html()},hide:!0,items:"[title]:not([disabled])",position:{my:"left top+15",at:"left bottom",collision:"flipfit flip"},show:!0,tooltipClass:null,track:!1,close:null,open:null},_addDescribedBy:function(e,i){var n=(e.attr("aria-describedby")||"").split(/\s+/);n.push(i),e.data("ui-tooltip-id",i).attr("aria-describedby",t.trim(n.join(" ")))},_removeDescribedBy:function(e){var i=e.data("ui-tooltip-id"),n=(e.attr("aria-describedby")||"").split(/\s+/),s=t.inArray(i,n);-1!==s&&n.splice(s,1),e.removeData("ui-tooltip-id"),n=t.trim(n.join(" ")),n?e.attr("aria-describedby",n):e.removeAttr("aria-describedby")},_create:function(){this._on({mouseover:"open",focusin:"open"}),this.tooltips={},this.parents={},this.options.disabled&&this._disable(),this.liveRegion=t("<div>").attr({role:"log","aria-live":"assertive","aria-relevant":"additions"}).addClass("ui-helper-hidden-accessible").appendTo(this.document[0].body)},_setOption:function(e,i){var n=this;return"disabled"===e?(this[i?"_disable":"_enable"](),void(this.options[e]=i)):(this._super(e,i),void("content"===e&&t.each(this.tooltips,function(t,e){n._updateContent(e.element)})))},_disable:function(){var e=this;t.each(this.tooltips,function(i,n){var s=t.Event("blur");s.target=s.currentTarget=n.element[0],e.close(s,!0)}),this.element.find(this.options.items).addBack().each(function(){var e=t(this);e.is("[title]")&&e.data("ui-tooltip-title",e.attr("title")).removeAttr("title")})},_enable:function(){this.element.find(this.options.items).addBack().each(function(){var e=t(this);e.data("ui-tooltip-title")&&e.attr("title",e.data("ui-tooltip-title"))})},open:function(e){var i=this,n=t(e?e.target:this.element).closest(this.options.items);n.length&&!n.data("ui-tooltip-id")&&(n.attr("title")&&n.data("ui-tooltip-title",n.attr("title")),n.data("ui-tooltip-open",!0),e&&"mouseover"===e.type&&n.parents().each(function(){var e,n=t(this);n.data("ui-tooltip-open")&&(e=t.Event("blur"),e.target=e.currentTarget=this,i.close(e,!0)),n.attr("title")&&(n.uniqueId(),i.parents[this.id]={element:this,title:n.attr("title")},n.attr("title",""))}),this._registerCloseHandlers(e,n),this._updateContent(n,e))},_updateContent:function(t,e){var i,n=this.options.content,s=this,o=e?e.type:null;return"string"==typeof n?this._open(e,t,n):(i=n.call(t[0],function(i){s._delay(function(){t.data("ui-tooltip-open")&&(e&&(e.type=o),this._open(e,t,i))})}),void(i&&this._open(e,t,i)))},_open:function(e,i,n){function s(t){h.of=t,a.is(":hidden")||a.position(h)}var o,a,r,l,h=t.extend({},this.options.position);if(n){if(o=this._find(i))return void o.tooltip.find(".ui-tooltip-content").html(n);i.is("[title]")&&(e&&"mouseover"===e.type?i.attr("title",""):i.removeAttr("title")),o=this._tooltip(i),a=o.tooltip,this._addDescribedBy(i,a.attr("id")),a.find(".ui-tooltip-content").html(n),this.liveRegion.children().hide(),n.clone?(l=n.clone(),l.removeAttr("id").find("[id]").removeAttr("id")):l=n,t("<div>").html(l).appendTo(this.liveRegion),this.options.track&&e&&/^mouse/.test(e.type)?(this._on(this.document,{mousemove:s}),s(e)):a.position(t.extend({of:i},this.options.position)),a.hide(),this._show(a,this.options.show),this.options.show&&this.options.show.delay&&(r=this.delayedShow=setInterval(function(){a.is(":visible")&&(s(h.of),clearInterval(r))},t.fx.interval)),this._trigger("open",e,{tooltip:a})}},_registerCloseHandlers:function(e,i){var n={keyup:function(e){if(e.keyCode===t.ui.keyCode.ESCAPE){var n=t.Event(e);n.currentTarget=i[0],this.close(n,!0)}}};i[0]!==this.element[0]&&(n.remove=function(){this._removeTooltip(this._find(i).tooltip)}),e&&"mouseover"!==e.type||(n.mouseleave="close"),e&&"focusin"!==e.type||(n.focusout="close"),this._on(!0,i,n)},close:function(e){var i,n=this,s=t(e?e.currentTarget:this.element),o=this._find(s);return o?(i=o.tooltip,void(o.closing||(clearInterval(this.delayedShow),s.data("ui-tooltip-title")&&!s.attr("title")&&s.attr("title",s.data("ui-tooltip-title")),this._removeDescribedBy(s),o.hiding=!0,i.stop(!0),this._hide(i,this.options.hide,function(){n._removeTooltip(t(this))}),s.removeData("ui-tooltip-open"),this._off(s,"mouseleave focusout keyup"),s[0]!==this.element[0]&&this._off(s,"remove"),this._off(this.document,"mousemove"),e&&"mouseleave"===e.type&&t.each(this.parents,function(e,i){t(i.element).attr("title",i.title),delete n.parents[e]}),o.closing=!0,this._trigger("close",e,{tooltip:i}),o.hiding||(o.closing=!1)))):void s.removeData("ui-tooltip-open")},_tooltip:function(e){var i=t("<div>").attr("role","tooltip").addClass("ui-tooltip ui-widget ui-corner-all ui-widget-content "+(this.options.tooltipClass||"")),n=i.uniqueId().attr("id");return t("<div>").addClass("ui-tooltip-content").appendTo(i),i.appendTo(this.document[0].body),this.tooltips[n]={element:e,tooltip:i}},_find:function(t){var e=t.data("ui-tooltip-id");return e?this.tooltips[e]:null},_removeTooltip:function(t){t.remove(),delete this.tooltips[t.attr("id")]},_destroy:function(){var e=this;t.each(this.tooltips,function(i,n){var s=t.Event("blur"),o=n.element;s.target=s.currentTarget=o[0],e.close(s,!0),t("#"+i).remove(),o.data("ui-tooltip-title")&&(o.attr("title")||o.attr("title",o.data("ui-tooltip-title")),o.removeData("ui-tooltip-title"))}),this.liveRegion.remove()}})}),function(e){jQuery.fn.extend({slimScroll:function(i){var n=e.extend({width:"auto",height:"250px",size:"7px",color:"#000",position:"right",distance:"1px",start:"top",opacity:.4,alwaysVisible:!1,disableFadeOut:!1,railVisible:!1,railColor:"#333",railOpacity:.2,railDraggable:!0,railClass:"slimScrollRail",barClass:"slimScrollBar",wrapperClass:"slimScrollDiv",allowPageScroll:!1,wheelStep:20,touchScrollStep:200,borderRadius:"7px",railBorderRadius:"7px"},i);return this.each(function(){function s(t){t=t||window.event;var i=0;t.wheelDelta&&(i=-t.wheelDelta/120),t.detail&&(i=t.detail/3),e(t.target||t.srcTarget||t.srcElement).closest("."+n.wrapperClass).is(_.parent())&&o(i,!0),t.preventDefault&&!y&&t.preventDefault(),y||(t.returnValue=!1)}function o(t,e,i){y=!1;var s=t,o=_.outerHeight()-x.outerHeight();e&&(s=parseInt(x.css("top"))+t*parseInt(n.wheelStep)/100*x.outerHeight(),s=Math.min(Math.max(s,0),o),s=t>0?Math.ceil(s):Math.floor(s),x.css({top:s+"px"})),g=parseInt(x.css("top"))/(_.outerHeight()-x.outerHeight()),s=g*(_[0].scrollHeight-_.outerHeight()),i&&(s=t,t=s/_[0].scrollHeight*_.outerHeight(),t=Math.min(Math.max(t,0),o),x.css({top:t+"px"})),_.scrollTop(s),_.trigger("slimscrolling",~~s),l(),h()}function a(){window.addEventListener?(this.addEventListener("DOMMouseScroll",s,!1),this.addEventListener("mousewheel",s,!1)):document.attachEvent("onmousewheel",s)}function r(){m=Math.max(_.outerHeight()/_[0].scrollHeight*_.outerHeight(),b),x.css({height:m+"px"});var t=m==_.outerHeight()?"none":"block";x.css({display:t})}function l(){r(),clearTimeout(p),g==~~g?(y=n.allowPageScroll,v!=g&&_.trigger("slimscroll",0==~~g?"top":"bottom")):y=!1,v=g,m>=_.outerHeight()?y=!0:(x.stop(!0,!0).fadeIn("fast"),n.railVisible&&C.stop(!0,!0).fadeIn("fast"))}function h(){n.alwaysVisible||(p=setTimeout(function(){n.disableFadeOut&&c||u||d||(x.fadeOut("slow"),C.fadeOut("slow"))},1e3))}var c,u,d,p,f,m,g,v,b=30,y=!1,_=e(this);if(_.parent().hasClass(n.wrapperClass)){var w=_.scrollTop(),x=_.parent().find("."+n.barClass),C=_.parent().find("."+n.railClass);if(r(),e.isPlainObject(i)){if("height"in i&&"auto"==i.height){_.parent().css("height","auto"),_.css("height","auto");var k=_.parent().parent().height();_.parent().css("height",k),_.css("height",k)}if("scrollTo"in i)w=parseInt(n.scrollTo);else if("scrollBy"in i)w+=parseInt(n.scrollBy);else if("destroy"in i)return x.remove(),C.remove(),void _.unwrap();o(w,!1,!0)}}else{n.height="auto"==i.height?_.parent().height():i.height,w=e("<div></div>").addClass(n.wrapperClass).css({position:"relative",overflow:"hidden",width:n.width,height:n.height}),_.css({overflow:"hidden",width:n.width,height:n.height});var C=e("<div></div>").addClass(n.railClass).css({width:n.size,height:"100%",position:"absolute",top:0,display:n.alwaysVisible&&n.railVisible?"block":"none","border-radius":n.railBorderRadius,background:n.railColor,opacity:n.railOpacity,zIndex:90}),x=e("<div></div>").addClass(n.barClass).css({background:n.color,width:n.size,position:"absolute",top:0,opacity:n.opacity,display:n.alwaysVisible?"block":"none","border-radius":n.borderRadius,BorderRadius:n.borderRadius,MozBorderRadius:n.borderRadius,WebkitBorderRadius:n.borderRadius,zIndex:99}),k="right"==n.position?{right:n.distance}:{left:n.distance};C.css(k),x.css(k),_.wrap(w),_.parent().append(x),_.parent().append(C),n.railDraggable&&x.bind("mousedown",function(i){var n=e(document);return d=!0,t=parseFloat(x.css("top")),pageY=i.pageY,n.bind("mousemove.slimscroll",function(e){currTop=t+e.pageY-pageY,x.css("top",currTop),o(0,x.position().top,!1)}),n.bind("mouseup.slimscroll",function(t){d=!1,h(),n.unbind(".slimscroll")}),!1}).bind("selectstart.slimscroll",function(t){return t.stopPropagation(),t.preventDefault(),!1}),C.hover(function(){l()},function(){h()}),x.hover(function(){u=!0},function(){u=!1}),_.hover(function(){c=!0,l(),h()},function(){c=!1,h()}),_.bind("touchstart",function(t,e){t.originalEvent.touches.length&&(f=t.originalEvent.touches[0].pageY)}),_.bind("touchmove",function(t){y||t.originalEvent.preventDefault(),t.originalEvent.touches.length&&(o((f-t.originalEvent.touches[0].pageY)/n.touchScrollStep,!0),f=t.originalEvent.touches[0].pageY)}),r(),"bottom"===n.start?(x.css({top:_.outerHeight()-x.outerHeight()}),o(0,!0)):"top"!==n.start&&(o(e(n.start).position().top,null,!0),n.alwaysVisible||x.hide()),a()}}),this}}),jQuery.fn.extend({slimscroll:jQuery.fn.slimScroll})}(jQuery),function(t,e,i,n,s){var o=t(e),a=t(i);t.fn.fullpage=function(r){function l(t){t.find(".fp-slides").after('<div class="fp-controlArrow fp-prev"></div><div class="fp-controlArrow fp-next"></div>'),"#fff"!=r.controlArrowColor&&(t.find(".fp-controlArrow.fp-next").css("border-color","transparent transparent transparent "+r.controlArrowColor),t.find(".fp-controlArrow.fp-prev").css("border-color","transparent "+r.controlArrowColor+" transparent transparent")),r.loopHorizontal||t.find(".fp-controlArrow.fp-prev").hide()}function h(){re.append('<div id="fp-nav"><ul></ul></div>'),ye=t("#fp-nav"),ye.addClass(r.navigationPosition);for(var e=0;e<t(".fp-section").length;e++){var i="";r.anchors.length&&(i=r.anchors[e]);var i='<li><a href="#'+i+'"><span></span></a>',n=r.navigationTooltips[e];"undefined"!=typeof n&&""!==n&&(i+='<div class="fp-tooltip '+r.navigationPosition+'">'+n+"</div>"),i+="</li>",ye.find("ul").append(i)}}function c(){t(".fp-section").each(function(){var e=t(this).find(".fp-slide");e.length?e.each(function(){O(t(this))}):O(t(this))}),t.isFunction(r.afterRender)&&r.afterRender.call(this)}function u(){var e;if(!r.autoScrolling||r.scrollBar){for(var s=o.scrollTop(),a=0,l=n.abs(s-i.querySelectorAll(".fp-section")[0].offsetTop),h=i.querySelectorAll(".fp-section"),c=0;c<h.length;++c){var u=n.abs(s-h[c].offsetTop);l>u&&(a=c,l=u)}e=t(h).eq(a)}if(!r.autoScrolling||r.scrollBar){if(!e.hasClass("active")){if(ke=!0,s=t(".fp-section.active"),a=s.index(".fp-section")+1,l=z(e),h=e.data("anchor"),c=e.index(".fp-section")+1,u=e.find(".fp-slide.active"),u.length)var d=u.data("anchor"),p=u.index();ve&&(e.addClass("active").siblings().removeClass("active"),t.isFunction(r.onLeave)&&r.onLeave.call(s,a,c,l),t.isFunction(r.afterLoad)&&r.afterLoad.call(e,h,c),H(h,c-1),r.anchors.length&&(me=h,Y(p,d,h,c))),clearTimeout(xe),xe=setTimeout(function(){ke=!1},100)}r.fitToSection&&(clearTimeout(Ce),Ce=setTimeout(function(){ve&&(t(".fp-section.active").is(e)&&(fe=!0),x(e),fe=!1)},1e3))}}function d(t){return t.find(".fp-slides").length?t.find(".fp-slide.active").find(".fp-scrollable"):t.find(".fp-scrollable")}function p(t,e){if(_e[t]){var i,n;if("down"==t?(i="bottom",n=le.moveSectionDown):(i="top",n=le.moveSectionUp),0<e.length){if(!(i="top"===i?!e.scrollTop():"bottom"===i?e.scrollTop()+1+e.innerHeight()>=e[0].scrollHeight:void 0))return!0;n()}else n()}}function f(e){var i=e.originalEvent;if(!m(e.target)&&g(i)){r.autoScrolling&&e.preventDefault(),e=t(".fp-section.active");var s=d(e);ve&&!he&&(i=Z(i),Se=i.y,Ie=i.x,e.find(".fp-slides").length&&n.abs(Te-Ie)>n.abs(De-Se)?n.abs(Te-Ie)>o.width()/100*r.touchSensitivity&&(Te>Ie?_e.right&&le.moveSlideRight():_e.left&&le.moveSlideLeft()):r.autoScrolling&&n.abs(De-Se)>o.height()/100*r.touchSensitivity&&(De>Se?p("down",s):Se>De&&p("up",s)))}}function m(e,i){i=i||0;var n=t(e).parent();return i<r.normalScrollElementTouchThreshold&&n.is(r.normalScrollElements)?!0:i==r.normalScrollElementTouchThreshold?!1:m(n,++i)}function g(t){return"undefined"==typeof t.pointerType||"mouse"!=t.pointerType}function v(t){t=t.originalEvent,r.fitToSection&&ae.stop(),g(t)&&(t=Z(t),De=t.y,Te=t.x)}function b(t,e){for(var i=0,s=t.slice(n.max(t.length-e,1)),o=0;o<s.length;o++)i+=s[o];return n.ceil(i/e)}function y(i){var s=(new Date).getTime();if(r.autoScrolling){i=e.event||i;var o=i.wheelDelta||-i.deltaY||-i.detail,a=n.max(-1,n.min(1,o));return 149<be.length&&be.shift(),be.push(n.abs(o)),r.scrollBar&&(i.preventDefault?i.preventDefault():i.returnValue=!1),i=t(".fp-section.active"),i=d(i),o=s-Ee,Ee=s,o>200&&(be=[],console.log("borro!!!")),ve&&(s=b(be,10),o=b(be,70),s>=o&&(0>a?p("down",i):p("up",i))),!1}r.fitToSection&&ae.stop()}function _(e){var i=t(".fp-section.active").find(".fp-slides");if(i.length&&!he){var n=i.find(".fp-slide.active"),s=null,s="prev"===e?n.prev(".fp-slide"):n.next(".fp-slide");if(!s.length){if(!r.loopHorizontal)return;s=n.siblings("prev"===e?":last":":first")}he=!0,E(i,s)}}function w(){t(".fp-slide.active").each(function(){te(t(this))})}function x(e,i,n){var s=e.position();if("undefined"!=typeof s&&(i={element:e,callback:i,isMovementUp:n,dest:s,dtop:s.top,yMovement:z(e),anchorLink:e.data("anchor"),sectionIndex:e.index(".fp-section"),activeSlide:e.find(".fp-slide.active"),activeSection:t(".fp-section.active"),leavingSection:t(".fp-section.active").index(".fp-section")+1,localIsResizing:fe},!(i.activeSection.is(e)&&!fe||r.scrollBar&&o.scrollTop()===i.dtop))){if(i.activeSlide.length)var a=i.activeSlide.data("anchor"),l=i.activeSlide.index();r.autoScrolling&&r.continuousVertical&&"undefined"!=typeof i.isMovementUp&&(!i.isMovementUp&&"up"==i.yMovement||i.isMovementUp&&"down"==i.yMovement)&&(i.isMovementUp?t(".fp-section.active").before(i.activeSection.nextAll(".fp-section")):t(".fp-section.active").after(i.activeSection.prevAll(".fp-section").get().reverse()),ee(t(".fp-section.active").position().top),w(),i.wrapAroundElements=i.activeSection,i.dest=i.element.position(),i.dtop=i.dest.top,i.yMovement=z(i.element)),e.addClass("active").siblings().removeClass("active"),ve=!1,Y(l,a,i.anchorLink,i.sectionIndex),t.isFunction(r.onLeave)&&!i.localIsResizing&&r.onLeave.call(i.activeSection,i.leavingSection,i.sectionIndex+1,i.yMovement),C(i),me=i.anchorLink,H(i.anchorLink,i.sectionIndex)}}function C(e){if(r.css3&&r.autoScrolling&&!r.scrollBar)R("translate3d(0px, -"+e.dtop+"px, 0px)",!0),setTimeout(function(){T(e)},r.scrollingSpeed);else{var i=k(e);t(i.element).animate(i.options,r.scrollingSpeed,r.easing).promise().done(function(){T(e)})}}function k(t){var e={};return r.autoScrolling&&!r.scrollBar?(e.options={top:-t.dtop},e.element=".fullpage-wrapper"):(e.options={scrollTop:t.dtop},e.element="html, body"),e}function D(e){e.wrapAroundElements&&e.wrapAroundElements.length&&(e.isMovementUp?t(".fp-section:first").before(e.wrapAroundElements):t(".fp-section:last").after(e.wrapAroundElements),ee(t(".fp-section.active").position().top),w())}function T(e){D(e),t.isFunction(r.afterLoad)&&!e.localIsResizing&&r.afterLoad.call(e.element,e.anchorLink,e.sectionIndex+1),ve=!0,setTimeout(function(){t.isFunction(e.callback)&&e.callback.call(this)},600)}function S(){if(!ke){var t=e.location.hash.replace("#","").split("/"),i=t[0],t=t[1];if(i.length){var n="undefined"==typeof me,s="undefined"==typeof me&&"undefined"==typeof t&&!he;(i&&i!==me&&!n||s||!he&&ge!=t)&&j(i,t)}}}function I(t){ve&&(t.pageY<Ne?le.moveSectionUp():t.pageY>Ne&&le.moveSectionDown()),Ne=t.pageY}function E(e,i){var n=i.position(),s=e.find(".fp-slidesContainer").parent(),o=i.index(),a=e.closest(".fp-section"),l=a.index(".fp-section"),h=a.data("anchor"),c=a.find(".fp-slidesNav"),u=V(i),d=fe;if(r.onSlideLeave){var p=a.find(".fp-slide.active"),f=p.index(),m;m=f==o?"none":f>o?"left":"right",d||"none"===m||t.isFunction(r.onSlideLeave)&&r.onSlideLeave.call(p,h,l+1,f,m)}i.addClass("active").siblings().removeClass("active"),!r.loopHorizontal&&r.controlArrows&&(a.find(".fp-controlArrow.fp-prev").toggle(0!==o),a.find(".fp-controlArrow.fp-next").toggle(!i.is(":last-child"))),a.hasClass("active")&&Y(o,u,h,l);var g=function(){d||t.isFunction(r.afterSlideLoad)&&r.afterSlideLoad.call(i,h,l+1,u,o),he=!1};r.css3?(n="translate3d(-"+n.left+"px, 0px, 0px)",P(e.find(".fp-slidesContainer"),0<r.scrollingSpeed).css(ie(n)),setTimeout(function(){g()},r.scrollingSpeed,r.easing)):s.animate({scrollLeft:n.left},r.scrollingSpeed,r.easing,function(){g()}),c.find(".active").removeClass("active"),c.find("li").eq(o).find("a").addClass("active")}function M(){if(N(),ce){var e=t(i.activeElement);e.is("textarea")||e.is("input")||e.is("select")||(e=o.height(),n.abs(e-Pe)>20*n.max(Pe,e)/100&&(le.reBuild(!0),Pe=e))}else clearTimeout(Ae),Ae=setTimeout(function(){le.reBuild(!0)},500)}function N(){if(r.responsive){var e=de.hasClass("fp-responsive");o.width()<r.responsive?e||(le.setAutoScrolling(!1,"internal"),le.setFitToSection(!1,"internal"),t("#fp-nav").hide(),de.addClass("fp-responsive")):e&&(le.setAutoScrolling(we.autoScrolling,"internal"),le.setFitToSection(we.autoScrolling,"internal"),t("#fp-nav").show(),de.removeClass("fp-responsive"))}}function P(t){var e="all "+r.scrollingSpeed+"ms "+r.easingcss3;return t.removeClass("fp-notransition"),t.css({"-webkit-transition":e,transition:e})}function A(t,e){if(825>t||900>e){var i=n.min(100*t/825,100*e/900).toFixed(2);re.css("font-size",i+"%")}else re.css("font-size","100%")}function H(e,i){r.menu&&(t(r.menu).find(".active").removeClass("active"),t(r.menu).find('[data-menuanchor="'+e+'"]').addClass("active")),r.navigation&&(t("#fp-nav").find(".active").removeClass("active"),e?t("#fp-nav").find('a[href="#'+e+'"]').addClass("active"):t("#fp-nav").find("li").eq(i).find("a").addClass("active"))}function z(e){var i=t(".fp-section.active").index(".fp-section");return e=e.index(".fp-section"),i==e?"none":i>e?"up":"down"}function O(t){t.css("overflow","hidden");var e=t.closest(".fp-section"),i=t.find(".fp-scrollable"),n;i.length?n=i.get(0).scrollHeight:(n=t.get(0).scrollHeight,r.verticalCentered&&(n=t.find(".fp-tableCell").get(0).scrollHeight)),e=pe-parseInt(e.css("padding-bottom"))-parseInt(e.css("padding-top")),n>e?i.length?i.css("height",e+"px").parent().css("height",e+"px"):(r.verticalCentered?t.find(".fp-tableCell").wrapInner('<div class="fp-scrollable" />'):t.wrapInner('<div class="fp-scrollable" />'),t.find(".fp-scrollable").slimScroll({allowPageScroll:!0,height:e+"px",size:"10px",alwaysVisible:!0})):W(t),t.css("overflow","")}function W(t){t.find(".fp-scrollable").children().first().unwrap().unwrap(),t.find(".slimScrollBar").remove(),t.find(".slimScrollRail").remove()}function L(t){t.addClass("fp-table").wrapInner('<div class="fp-tableCell" style="height:'+F(t)+'px;" />')}function F(t){var e=pe;return(r.paddingTop||r.paddingBottom)&&(e=t,e.hasClass("fp-section")||(e=t.closest(".fp-section")),t=parseInt(e.css("padding-top"))+parseInt(e.css("padding-bottom")),e=pe-t),e}function R(t,e){e?P(de):de.addClass("fp-notransition"),de.css(ie(t)),setTimeout(function(){de.removeClass("fp-notransition")},10)}function j(e,i){var n;"undefined"==typeof i&&(i=0),n=isNaN(e)?t('[data-anchor="'+e+'"]'):t(".fp-section").eq(e-1),e===me||n.hasClass("active")?B(n,i):x(n,function(){B(n,i)})}function B(t,e){if("undefined"!=typeof e){var i=t.find(".fp-slides"),n=i.find('[data-anchor="'+e+'"]');n.length||(n=i.find(".fp-slide").eq(e)),n.length&&E(i,n)}}function q(t,e){t.append('<div class="fp-slidesNav"><ul></ul></div>');var i=t.find(".fp-slidesNav");i.addClass(r.slidesNavPosition);for(var n=0;e>n;n++)i.find("ul").append('<li><a href="#"><span></span></a></li>');i.css("margin-left","-"+i.width()/2+"px"),i.find("li").first().find("a").addClass("active")}function Y(t,e,i,n){n="",r.anchors.length&&(t?("undefined"!=typeof i&&(n=i),"undefined"==typeof e&&(e=t),ge=e,U(n+"/"+e)):("undefined"!=typeof t&&(ge=e),U(i))),K()}function U(t){if(r.recordHistory)location.hash=t;else if(ce||ue)history.replaceState(s,s,"#"+t);else{var i=e.location.href.split("#")[0];e.location.replace(i+"#"+t)}}function V(t){var e=t.data("anchor");return t=t.index(".fp-slide"),"undefined"==typeof e&&(e=t),e}function K(){var e=t(".fp-section.active"),i=e.find(".fp-slide.active"),n=e.data("anchor"),s=V(i),e=e.index(".fp-section"),e=String(e);r.anchors.length&&(e=n),i.length&&(e=e+"-"+s),e=e.replace("/","-").replace("#",""),re[0].className=re[0].className.replace(/\b\s?fp-viewing-[^\s]+\b/g,""),re.addClass("fp-viewing"+e)}function X(){var t=i.createElement("p"),n,o={webkitTransform:"-webkit-transform",OTransform:"-o-transform",msTransform:"-ms-transform",MozTransform:"-moz-transform",transform:"transform"};i.body.insertBefore(t,null);for(var a in o)t.style[a]!==s&&(t.style[a]="translate3d(1px,1px,1px)",n=e.getComputedStyle(t).getPropertyValue(o[a]));return i.body.removeChild(t),n!==s&&0<n.length&&"none"!==n}function G(){if(ce||ue){var t=J();a.off("touchstart "+t.down).on("touchstart "+t.down,v),a.off("touchmove "+t.move).on("touchmove "+t.move,f)}}function Q(){if(ce||ue){var t=J();a.off("touchstart "+t.down),a.off("touchmove "+t.move)}}function J(){return e.PointerEvent?{down:"pointerdown",move:"pointermove"}:{down:"MSPointerDown",move:"MSPointerMove"}}function Z(t){var e=[];return e.y="undefined"!=typeof t.pageY&&(t.pageY||t.pageX)?t.pageY:t.touches[0].pageY,e.x="undefined"!=typeof t.pageX&&(t.pageY||t.pageX)?t.pageX:t.touches[0].pageX,ue&&g(t)&&(e.y=t.touches[0].pageY,e.x=t.touches[0].pageX),e}function te(t){le.setScrollingSpeed(0,"internal"),E(t.closest(".fp-slides"),t),le.setScrollingSpeed(we.scrollingSpeed,"internal")}function ee(t){r.scrollBar?de.scrollTop(t):r.css3?R("translate3d(0px, -"+t+"px, 0px)",!1):de.css("top",-t)}function ie(t){return{"-webkit-transform":t,"-moz-transform":t,"-ms-transform":t,transform:t}}function ne(){ee(0),t("#fp-nav, .fp-slidesNav, .fp-controlArrow").remove(),t(".fp-section").css({height:"","background-color":"",padding:""}),t(".fp-slide").css({width:""}),de.css({height:"",position:"","-ms-touch-action":"","touch-action":""}),t(".fp-section, .fp-slide").each(function(){W(t(this)),t(this).removeClass("fp-table active")}),de.addClass("fp-notransition"),de.find(".fp-tableCell, .fp-slidesContainer, .fp-slides").each(function(){t(this).replaceWith(this.childNodes)}),ae.scrollTop(0)}function se(t,e,i){r[t]=e,"internal"!==i&&(we[t]=e)}function oe(t,e){console&&console[t]&&console[t]("fullPage: "+e)}var ae=t("html, body"),re=t("body"),le=t.fn.fullpage;r=t.extend({menu:!1,anchors:[],navigation:!1,navigationPosition:"right",navigationTooltips:[],slidesNavigation:!1,slidesNavPosition:"bottom",scrollBar:!1,css3:!0,scrollingSpeed:700,autoScrolling:!0,fitToSection:!0,easing:"easeInOutCubic",easingcss3:"ease",loopBottom:!1,loopTop:!1,loopHorizontal:!0,continuousVertical:!1,normalScrollElements:null,scrollOverflow:!1,touchSensitivity:5,normalScrollElementTouchThreshold:5,keyboardScrolling:!0,animateAnchor:!0,recordHistory:!0,controlArrows:!0,controlArrowColor:"#fff",verticalCentered:!0,resize:!1,sectionsColor:[],paddingTop:0,paddingBottom:0,fixedElements:null,responsive:0,sectionSelector:".section",slideSelector:".slide",afterLoad:null,onLeave:null,afterRender:null,afterResize:null,afterReBuild:null,afterSlideLoad:null,onSlideLeave:null},r),function(){r.continuousVertical&&(r.loopTop||r.loopBottom)&&(r.continuousVertical=!1,oe("warn","Option `loopTop/loopBottom` is mutually exclusive with `continuousVertical`; `continuousVertical` disabled")),r.continuousVertical&&r.scrollBar&&(r.continuousVertical=!1,oe("warn","Option `scrollBar` is mutually exclusive with `continuousVertical`; `continuousVertical` disabled")),t.each(r.anchors,function(e,i){(t("#"+i).length||t('[name="'+i+'"]').length)&&oe("error","data-anchor tags can not have the same value as any `id` element on the site (or `name` element for IE).")})}(),t.extend(t.easing,{easeInOutCubic:function(t,e,i,n,s){return 1>(e/=s/2)?n/2*e*e*e+i:n/2*((e-=2)*e*e+2)+i}}),t.extend(t.easing,{easeInQuart:function(t,e,i,n,s){return n*(e/=s)*e*e*e+i}}),le.setAutoScrolling=function(e,i){se("autoScrolling",e,i);var n=t(".fp-section.active");r.autoScrolling&&!r.scrollBar?(ae.css({overflow:"hidden",height:"100%"}),le.setRecordHistory(r.recordHistory,"internal"),de.css({"-ms-touch-action":"none","touch-action":"none"}),n.length&&ee(n.position().top)):(ae.css({overflow:"visible",height:"initial"}),le.setRecordHistory(!1,"internal"),de.css({"-ms-touch-action":"","touch-action":""}),ee(0),n.length&&ae.scrollTop(n.position().top))
},le.setRecordHistory=function(t,e){se("recordHistory",t,e)},le.setScrollingSpeed=function(t,e){se("scrollingSpeed",t,e)},le.setFitToSection=function(t,e){se("fitToSection",t,e)},le.setMouseWheelScrolling=function(t){t?i.addEventListener?(i.addEventListener("mousewheel",y,!1),i.addEventListener("wheel",y,!1)):i.attachEvent("onmousewheel",y):i.addEventListener?(i.removeEventListener("mousewheel",y,!1),i.removeEventListener("wheel",y,!1)):i.detachEvent("onmousewheel",y)},le.setAllowScrolling=function(e,i){"undefined"!=typeof i?(i=i.replace(" ","").split(","),t.each(i,function(t,i){switch(i){case"up":_e.up=e;break;case"down":_e.down=e;break;case"left":_e.left=e;break;case"right":_e.right=e;break;case"all":le.setAllowScrolling(e)}})):e?(le.setMouseWheelScrolling(!0),G()):(le.setMouseWheelScrolling(!1),Q())},le.setKeyboardScrolling=function(t){r.keyboardScrolling=t},le.moveSectionUp=function(){var e=t(".fp-section.active").prev(".fp-section");e.length||!r.loopTop&&!r.continuousVertical||(e=t(".fp-section").last()),e.length&&x(e,null,!0)},le.moveSectionDown=function(){var e=t(".fp-section.active").next(".fp-section");e.length||!r.loopBottom&&!r.continuousVertical||(e=t(".fp-section").first()),e.length&&x(e,null,!1)},le.moveTo=function(e,i){var n="",n=isNaN(e)?t('[data-anchor="'+e+'"]'):t(".fp-section").eq(e-1);"undefined"!=typeof i?j(e,i):0<n.length&&x(n)},le.moveSlideRight=function(){_("next")},le.moveSlideLeft=function(){_("prev")},le.reBuild=function(e){if(!de.hasClass("fp-destroyed")){fe=!0;var i=o.width();pe=o.height(),r.resize&&A(pe,i),t(".fp-section").each(function(){var e=t(this).find(".fp-slides"),i=t(this).find(".fp-slide");r.verticalCentered&&t(this).find(".fp-tableCell").css("height",F(t(this))+"px"),t(this).css("height",pe+"px"),r.scrollOverflow&&(i.length?i.each(function(){O(t(this))}):O(t(this))),i.length&&E(e,e.find(".fp-slide.active"))}),i=t(".fp-section.active"),i.index(".fp-section")&&x(i),fe=!1,t.isFunction(r.afterResize)&&e&&r.afterResize.call(de),t.isFunction(r.afterReBuild)&&!e&&r.afterReBuild.call(de)}};var he=!1,ce=navigator.userAgent.match(/(iPhone|iPod|iPad|Android|playbook|silk|BlackBerry|BB10|Windows Phone|Tizen|Bada|webOS|IEMobile|Opera Mini)/),ue="ontouchstart"in e||0<navigator.msMaxTouchPoints||navigator.maxTouchPoints,de=t(this),pe=o.height(),fe=!1,me,ge,ve=!0,be=[],ye,_e={up:!0,down:!0,left:!0,right:!0},we=t.extend(!0,{},r);le.setAllowScrolling(!0),de.removeClass("fp-destroyed"),r.css3&&(r.css3=X()),t(this).length?(de.css({height:"100%",position:"relative"}),de.addClass("fullpage-wrapper")):oe("error","Error! Fullpage.js needs to be initialized with a selector. For example: $('#myContainer').fullpage();"),t(r.sectionSelector).each(function(){t(this).addClass("fp-section")}),t(r.slideSelector).each(function(){t(this).addClass("fp-slide")}),r.navigation&&h(),t(".fp-section").each(function(e){var i=t(this),n=t(this).find(".fp-slide"),s=n.length;if(e||0!==t(".fp-section.active").length||t(this).addClass("active"),t(this).css("height",pe+"px"),(r.paddingTop||r.paddingBottom)&&t(this).css("padding",r.paddingTop+" 0 "+r.paddingBottom+" 0"),"undefined"!=typeof r.sectionsColor[e]&&t(this).css("background-color",r.sectionsColor[e]),"undefined"!=typeof r.anchors[e]&&(t(this).attr("data-anchor",r.anchors[e]),t(this).hasClass("active")&&H(r.anchors[e],e)),s>1){e=100*s;var o=100/s;n.wrapAll('<div class="fp-slidesContainer" />'),n.parent().wrap('<div class="fp-slides" />'),t(this).find(".fp-slidesContainer").css("width",e+"%"),r.controlArrows&&l(t(this)),r.slidesNavigation&&q(t(this),s),n.each(function(e){t(this).css("width",o+"%"),r.verticalCentered&&L(t(this))}),i=i.find(".fp-slide.active"),i.length?te(i):n.eq(0).addClass("active")}else r.verticalCentered&&L(t(this))}).promise().done(function(){le.setAutoScrolling(r.autoScrolling,"internal");var n=t(".fp-section.active").find(".fp-slide.active");if(n.length&&(0!==t(".fp-section.active").index(".fp-section")||0===t(".fp-section.active").index(".fp-section")&&0!==n.index())&&te(n),r.fixedElements&&r.css3&&t(r.fixedElements).appendTo(re),r.navigation&&(ye.css("margin-top","-"+ye.height()/2+"px"),ye.find("li").eq(t(".fp-section.active").index(".fp-section")).find("a").addClass("active")),r.menu&&r.css3&&t(r.menu).closest(".fullpage-wrapper").length&&t(r.menu).appendTo(re),r.scrollOverflow?("complete"===i.readyState&&c(),o.on("load",c)):t.isFunction(r.afterRender)&&r.afterRender.call(de),N(),!r.animateAnchor&&(n=e.location.hash.replace("#","").split("/")[0],n.length)){var s=t('[data-anchor="'+n+'"]');s.length&&(r.autoScrolling?ee(s.position().top):(ee(0),ae.scrollTop(s.position().top)),H(n,null),t.isFunction(r.afterLoad)&&r.afterLoad.call(s,n,s.index(".fp-section")+1),s.addClass("active").siblings().removeClass("active"))}K(),o.on("load",function(){var t=e.location.hash.replace("#","").split("/"),i=t[0],t=t[1];i&&j(i,t)})});var xe,Ce,ke=!1;o.on("scroll",u);var De=0,Te=0,Se=0,Ie=0,Ee=(new Date).getTime();o.on("hashchange",S),a.keydown(function(e){clearTimeout(Me);var n=t(i.activeElement);n.is("textarea")||n.is("input")||n.is("select")||!r.keyboardScrolling||!r.autoScrolling||(-1<t.inArray(e.which,[40,38,32,33,34])&&e.preventDefault(),Me=setTimeout(function(){var i=e.shiftKey;switch(e.which){case 38:case 33:le.moveSectionUp();break;case 32:if(i){le.moveSectionUp();break}case 40:case 34:le.moveSectionDown();break;case 36:le.moveTo(1);break;case 35:le.moveTo(t(".fp-section").length);break;case 37:le.moveSlideLeft();break;case 39:le.moveSlideRight()}},150))});var Me;de.mousedown(function(t){2==t.which&&(Ne=t.pageY,de.on("mousemove",I))}),de.mouseup(function(t){2==t.which&&de.off("mousemove")});var Ne=0;a.on("click touchstart","#fp-nav a",function(e){e.preventDefault(),e=t(this).parent().index(),x(t(".fp-section").eq(e))}),a.on("click touchstart",".fp-slidesNav a",function(e){e.preventDefault(),e=t(this).closest(".fp-section").find(".fp-slides");var i=e.find(".fp-slide").eq(t(this).closest("li").index());E(e,i)}),r.normalScrollElements&&(a.on("mouseenter",r.normalScrollElements,function(){le.setMouseWheelScrolling(!1)}),a.on("mouseleave",r.normalScrollElements,function(){le.setMouseWheelScrolling(!0)})),t(".fp-section").on("click touchstart",".fp-controlArrow",function(){t(this).hasClass("fp-prev")?le.moveSlideLeft():le.moveSlideRight()}),o.resize(M);var Pe=pe,Ae;le.destroy=function(e){le.setAutoScrolling(!1,"internal"),le.setAllowScrolling(!1),le.setKeyboardScrolling(!1),de.addClass("fp-destroyed"),o.off("scroll",u).off("hashchange",S).off("resize",M),a.off("click","#fp-nav a").off("mouseenter","#fp-nav li").off("mouseleave","#fp-nav li").off("click",".fp-slidesNav a").off("mouseover",r.normalScrollElements).off("mouseout",r.normalScrollElements),t(".fp-section").off("click",".fp-controlArrow"),e&&ne()}}}(jQuery,window,document,Math),$(document).ready(function(){$("#wrapper").removeClass("invisible"),$("#wrapper").fullpage({menu:"#mainNav",verticalCentered:!1,responsive:900,scrollBar:!0,scrollingSpeed:900,anchors:["today","network","services","contact"],css3:!1,scrollOverflow:!0,afterRender:function(){$("#network-list").load("inc/network.html"),$("#clients-list").load("inc/clients.html"),$("#services-list").load("inc/services.html")},onLeave:function(t,e,i){2==t&&"down"==i?$(".section").eq(t-1).removeClass("moveDown").addClass("moveUp"):2==t&&"up"==i&&$(".section").eq(t-1).removeClass("moveUp").addClass("moveDown"),3==t&&"down"==i?$(".section").eq(t-1).removeClass("moveDown").addClass("moveUp"):3==t&&"up"==i&&$(".section").eq(t-1).removeClass("moveUp").addClass("moveDown"),$(".bg-color.bottom").toggleClass("moveDown",4==e),$(".bg-color.middle").toggleClass("active",1==t&&"down"==i||3==t&&"up"==i)}})});